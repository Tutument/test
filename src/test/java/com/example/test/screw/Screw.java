package com.example.test.screw;
...
public class Screw {
    ...
    static void contextLoads() {
        ...
        hikariConfig.setJdbcUrl("jdbc:mysql://127.0.0.1:3306/identity_verify?serverTimezone=GMT&characterEncoding=utf-8");
